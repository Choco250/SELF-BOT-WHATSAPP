...
</s> </s> </s> </s> </s> </s> </s> </s> </s> </s> </s> </s> </s> </s> </s> </s> </s> orang </s>const
	{
		WAConnection,
		MessageType,
		Presence,
...
fake = '*SELF-BOT*'
fakeimage = fs.readFileSync(`./media/cho.jpeg`)
prefix = '/'
public = false
...
*List Menu*
ᐈ ${prefix}sticker
ᐈ ${prefix}swm nama | author
ᐈ ${prefix}takestick namma | author
ᐈ ${prefix}colong <reply stiker>
ᐈ ${prefix}self
ᐈ ${prefix}public
ᐈ ${prefix}hidetag
ᐈ ${prefix}runtime
...
*Runtime :* ${aqul.runtime(anu)}`
			...
			if (chats.includes('P')){
				reply('*hallo ka, ketik ${prefix}menu untuk menampilkan list menu*')
				}
				
				if (chats.startsWith('>')){
					console.log(color('[Gemz]'), color(moment(qul.messageTimestamp * 1000).format('DD/MM/YY HH:mm:ss'), 'yellow'), color(`Choco Botz`))
